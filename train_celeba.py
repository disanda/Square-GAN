...
parser.add_argument('--adversarial_loss_mode', default='hinge_v1', choices=['gan', 'hinge_v1', 'hinge_v2', 'lsgan', 'wgan'])
...
parser.add_argument('--Gscale', type=int, default=0) # scale：网络隐藏层维度数,默认为 image_size//8 * image_size 
parser.add_argument('--Dscale', type=int, default=0) 
...
args.experiment_name += '_Gscale%d_Dscale%d_z_dim%d_imgSize%d_batch_size%d_D2Ev3_hingv1_kernel3' % (args.Gscale, args.Dscale, args.z_dim, args.img_size,args.batch_size)
