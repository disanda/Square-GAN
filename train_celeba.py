...
args.experiment_name += '_Gscale%d_Dscale%d_z_dim%d_imgSize%d' % (args.Gscale, args.Dscale, args.z_dim, args.img_size)
...
G = net.Generator(input_dim=args.z_dim, output_channels = args.img_channels, image_size=args.img_size, scale=args.Gscale, args=args.addTrainTimes).to(device)
D = net.Discriminator_SpectrualNorm(args.z_dim, input_channels = args.img_channels, image_size=args.img_size, scale=args.addTrainTimes).to(device)
