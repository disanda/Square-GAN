...
args.experiment_name += '_Gscale%d_Dscale%d_z_dim%d_imgSize%d_v2_2_nolr' % (args.Gscale, args.Dscale, args.z_dim, args.img_size)
...
G.load_state_dict(torch.load('./pre-model/GAN_GEN_SHADOW_8.pth',map_location=device)) #shadow的效果要好一些 
D.load_state_dict(torch.load('./pre-model/GAN_DIS_8.pth',map_location=device))
